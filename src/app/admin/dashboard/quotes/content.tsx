...
export default function QuotesContent() {
    ...
    function handleOnChangePerson(e: any, index: number) {
        setQuotes(prev => 
            prev.map((quote, i) => (
                i === index ? e.target.value : quote.person
            ))
        )
    }

    function handleOnChangeQuote(e: any, index: number) {
        setQuotes(prev => 
            prev.map((quote, i) => (
                i === index ? e.target.value : quote.quote
            ))
        )
    }
